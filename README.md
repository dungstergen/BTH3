# BTH3 - Kiểm thử hộp đen

Repository này triển khai 8 bài toán trong đề bài và bộ kiểm thử hộp đen tương ứng bằng JavaScript.

## Cấu trúc

- `src/bth3/index.js`: các hàm xử lý cho 8 bài toán
- `tests/`: bộ test `node:test`
